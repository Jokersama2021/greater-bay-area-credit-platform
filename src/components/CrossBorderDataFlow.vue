...
export default {
  ...
  setup() {
    ...
    const mainlandCities = ref([
      { id: 1, name: '廣州', x: 3, y: 25, isSending: false, isReceiving: false },
      { id: 2, name: '深圳', x: 8, y: 55, isSending: false, isReceiving: false },
      { id: 3, name: '佛山', x: 2, y: 40, isSending: false, isReceiving: false },
      { id: 4, name: '東莞', x: 6, y: 35, isSending: false, isReceiving: false },
      ...
      { id: 8, name: '江門', x: 1, y: 60, isSending: false, isReceiving: false },
      { id: 9, name: '肇慶', x: 3, y: 10, isSending: false, isReceiving: false }
    ])

    // 境外地區位置 - 分散在右侧
    const overseasCities = ref([
      { id: 10, name: '香港', x: 6, y: 40, isSending: false, isReceiving: false },
      { id: 11, name: '澳門', x: 3, y: 70, isSending: false, isReceiving: false }
    ])
    ...
    const createCityConnection = () => {
      // 随機決定传输方向：true = 内地到境外，false = 境外到内地
      ...
      const connection = {
        ...
        delay: 0,
        duration: 3,
        isReverse: !isMainlandToOverseas // 境外到内地時為反向
      }
