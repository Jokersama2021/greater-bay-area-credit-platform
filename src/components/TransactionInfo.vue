<template>
    <div class="modal">
      <div class="modal-content">
        ...
        <form @submit.prevent="submitTransaction">
          ...
          <input type="number" v-model="transactionDetails.block_number" placeholder="區块编号" required>
          ...
          <input type="number" v-model="transactionDetails.error_code" placeholder="错误代碼" required>
          ...
          <input type="number" v-model="transactionDetails.properties_block_number" placeholder="属性區块编号" required>
          ...
          <textarea v-model="transactionDetails.properties_args" placeholder="属性参數" required></textarea>
          ...
          <input type="number" v-model="transactionDetails.properties_error_code" placeholder="属性错误代碼" required>
  ...
  try {
  const response = await axios.post('http://localhost:3000/api/submitTransaction', transactionDetails.value);
